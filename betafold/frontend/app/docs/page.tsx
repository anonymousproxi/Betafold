      ...
      <div className="shell">
        <nav className="dash-nav">
          ...
          <div className="nav-center">
            ...
            <Link href="/docs" className="nav-link active" style={{ textDecoration: 'none' }}>Docs</Link>
          </div>
        ...
        <div className="dash-body">
          <div className="sidebar">
            ...
            <div className="sidebar-section">
              ...
              <Link href="/docs" className="s-item active"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>Reports Engine</Link>
            </div>
          </div>
          ...
          <div className="main-view" style={{ padding: '40px 60px' }}>
            <div className="page-header" style={{ marginBottom: 40 }}>
              <div>
                <div className="greeting-big">Platform Documentation</div>
                <div className="greeting-sub" style={{ marginTop: 8 }}>Architecture logic, asynchronous messaging vectors, and integration tutorials.</div>
              </div>
            </div>

            <div className="card-comp" style={{ lineHeight: 1.8, fontSize: 14 }}>
              <div className="card-hd"><div className="card-title">BetaFold Architecture Core</div><span className="badge b-purple pulse-ring">v3.0 Live</span></div>
              
              <h2 style={{ color: '#818cf8', fontWeight: 700, marginTop: 20, marginBottom: 8 }}>Asynchronous Biological Messaging</h2>
              <p style={{ color: 'var(--muted)', marginBottom: 20 }}>
                High-intensity Machine Learning structural evaluations do not compute locally. We offload heavy sequence processing to a Python-based distributed <strong>Celery Object Worker</strong> via Redis queueing logic. The Next.js frontend polls standard REST telemetry APIs to stream updates identically to the end user.
              </p>

              <h2 style={{ color: '#10b981', fontWeight: 700, marginTop: 30, marginBottom: 8 }}>State-of-the-Art Generative Analysis</h2>
              <p style={{ color: 'var(--muted)', marginBottom: 20 }}>
                Every single structural result triggers a concurrent Google Gemini LLM evaluation payload mapping specific hydrophobic nodes, identifying topological flaws, and extrapolating mutation data in natural language right next to your WebGL model.
              </p>

              <h2 style={{ color: '#06b6d4', fontWeight: 700, marginTop: 30, marginBottom: 8 }}>3D Deep Renderer</h2>
              <p style={{ color: 'var(--muted)', marginBottom: 20 }}>
                We embed the industry-standard PDBe Mol* renderer wrapped completely recursively to defeat multi-server CORS (Cross-Origin Resource Sharing) X-Frame-Options blocks—ensuring you ALWAYS have fluid real-time WebGL access to rotational geometries.
              </p>
            </div>
